...
def page_recommendations(df_filtered: pd.DataFrame | None,
    ...
    st.markdown(
        ...
        .step-num{
          font-weight:700;
          font-size:.80rem;
          color:#0f172a !important;              /* enforce dark text on light accent */
          background: var(--accent-1) !important;/*bright blue accent */
        ...
        .step-card:hover .step-num{
          background: var(--accent-2) !important; /* switch to violet accent on hover */
    ...
    # ── Evidence tabs
    tab1, tab2, tab3 = st.tabs(["🧭 Imbalance focus", "🚚 Hot-20 Pilot Plan", "📦 Download evidence"])
